...
本提示词已根据 `FIRST-DIALOG-COLD-START-DECONSTRUCTION.md`、`SANDBOX-RUN-20260531-FRESH-CLONE-DEVELOPER-SIMULATION.md`、`SANDBOX-RUN-20260531-AI-COLLABORATION-COLD-START-SIMULATION.md` 和 `SANDBOX-RUN-20260601-FINAL-FRESH-CLONE-AI-DEVELOPER-ACCEPTANCE.md` 调整为 6 阶段门:
